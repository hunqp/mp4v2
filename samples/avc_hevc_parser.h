...
} LC_MP4_MPEG4_AUDIO_OBJECT_TYPES_e;
...
const uint32_t LC_MP4_AVC_SPS_MAX_ID                                      = 255;
const uint32_t LC_MP4_AVC_SPS_MAX_NUM_REF_FRAMES_IN_PIC_ORDER_CNT_CYCLE   = 256;
const uint32_t LC_MP4_AVC_SPS_MAX_SCALING_LIST_COUNT                      = 12;

// avc

typedef struct {
    int scale[16];
} LC_MP4_AvcScalingList4x4;

typedef struct {
    int scale[64];
} LC_MP4_AvcScalingList8x8;
...
struct LC_MP4_AvcSequenceParameterSet {
    ...
    LC_MP4_AvcScalingList4x4 scaling_list_4x4[6];
    bool                  use_default_scaling_matrix_4x4[LC_MP4_AVC_SPS_MAX_SCALING_LIST_COUNT];
    LC_MP4_AvcScalingList8x8 scaling_list_8x8[6];
    uint8_t         use_default_scaling_matrix_8x8[LC_MP4_AVC_SPS_MAX_SCALING_LIST_COUNT];
    ...
    uint32_t offset_for_ref_frame[LC_MP4_AVC_SPS_MAX_NUM_REF_FRAMES_IN_PIC_ORDER_CNT_CYCLE];
